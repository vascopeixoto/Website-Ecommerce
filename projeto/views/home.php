				...
				<div id="meu_carrossel" class="carousel slide" data-ride="carousel">
					...
					<div class="carousel-inner" role="listbox">
						<div class="item active">
							<img src="img/me1.jpg" class="img-thumbnail center" alt="sou eu">
						...
						<div class="item">
							<img src="img/me2.jpg" class="img-thumbnail"  alt="mais uma foto minha">
							<div class="carousel-caption">
						...
						<div class="item">
							<img src="img/me3.jpeg" class="img-thumbnail"  alt="futsal">
							<div class="carousel-caption">
						...
						<div class="item">
							<img src="img/me4.jpeg" class="img-thumbnail"  alt="...">
							<div class="carousel-caption">
	...
	<div class="container">
		...
		<div class="row"> 
			<div class="col-sm-6 col-md-4"> 
				<div class="thumbnail"> 
					<img id="imagens" src="img/f1.jpeg" class="img-thumbnail"> 
			...
			<div class="col-sm-6 col-md-4"> 
				<div class="thumbnail"> 
					<img id="imagens" src="img/f2.webp" class="img-thumbnail"> 
					<div class="caption"> 
						<h3>Quem Somos</h3> 
			...
			<div class="col-sm-6 col-md-4"> 
				<div class="thumbnail"> 
					<img id="imagens" src="img/f3.jpeg" class="img-thumbnail"> 
					<div class="caption"> 
						<h3>Contactos</h3> 
