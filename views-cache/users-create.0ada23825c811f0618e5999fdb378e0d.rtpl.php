...
<section class="content-header">
  ...
  <ol class="breadcrumb">
    ...
    <li><a href="/ecommerce/index.php/admin/users">Utilizadores</a></li>
        ...
        <form role="form" action="/ecommerce/index.php/admin/users/create" method="post">
          <div class="box-body">
            ...
            <div class="form-group">
              ...
              <input type="password" class="form-control" id="despassword" name="despassword" placeholder="Digite a Password">
            </div>
            <div class="checkbox">
              <label>
                <input type="checkbox" name="inadmin" value="1"> Acesso de Admin
              </label>
            </div>
          </div>
          <!-- /.box-body -->
