...
<div class="lockscreen-wrapper">
  <div class="lockscreen-logo">
    <a href="/ecommerce/res/admin/index2.html"><b>Login</b>TW</a>
  </div>
  
   <div class="help-block text-center">
     Olá <?php echo htmlspecialchars( $name, ENT_COMPAT, 'UTF-8', FALSE ); ?>, digite uma nova password:
    </div>
  ...
  <div class="lockscreen-item">
    ...
    <form  action="/ecommerce/index.php/admin/forgot/reset" method="post">
      ...
      <div class="input-group">
        <input type="password" class="form-control" placeholder="Digite a nova password" name="password">
