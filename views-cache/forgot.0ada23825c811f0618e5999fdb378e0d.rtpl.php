  ...
  <div class="limiter">
		<div class="container-login100" style="background-image: url('/ecommerce/res/admin/images/bg-01.jpg');">
			<div class="wrap-login100 p-t-30 p-b-50">
				...
				<form action="/ecommerce/index.php/admin/forgot" method="post" class="login100-form validate-form p-b-33 p-t-5">
          ...
          <div class="help-block text-center" style="color: rgb(0, 0, 0);">
